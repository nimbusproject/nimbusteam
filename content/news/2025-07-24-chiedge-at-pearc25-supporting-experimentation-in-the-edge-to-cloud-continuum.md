...
<!--
  DRAFT FOR REVIEW.
  [VERIFY-1] RESOLVED — now links the 2021 CHI@Edge Community Workshop
             (https://chameleoncloud.org/chiedge-community-workshop/) and its resulting
             CHI@Edge Community Workshop Report (Zenodo DOI 10.5281/zenodo.5777344).
  [VERIFY-2] Student-poster arc (SC'21 -> SC'25) inferred from titles in
             content/publications/index.md and the Chameleon "at SC" blog posts; posters chosen
             for edge/edge-to-cloud themes. Two items need a human check:
               - SC'21 "One Fish, Two Fish" is worded softly ("early edge-topology work") because
                 CHI@Edge only debuted in 2021 and it may predate production use — confirm w/ Jason.
               - The SC'24 posters are attributed to the IBIS edge framework; confirm they ran on
                 CHI@Edge specifically vs. IBIS on other hardware — flag for Kate/Mike/Alicia.
-->

<p>Our paper <strong>&ldquo;CHI@Edge: Supporting Experimentation in the Edge to Cloud Continuum&rdquo;</strong> (Kate Keahey, Michael Sherman, Jason Anderson, and Mark Powers) was presented at <a href="https://pearc.acm.org/" target="_blank" rel="noopener">PEARC&rsquo;25</a> in Columbus, Ohio (July 20&ndash;24, 2025), where <strong>Mike Sherman</strong> gave the talk. The paper describes how <a href="https://www.chameleoncloud.org/experiment/chiedge/" target="_blank" rel="noopener">CHI@Edge</a> extends Chameleon&rsquo;s testbed model out to real edge devices &mdash; letting researchers bring their own hardware, orchestrate containers across the edge-to-cloud continuum, and run reproducible experiments spanning everything from single sensors to the data center. You can read the full paper on the <a href="https://chameleoncloud.org/media/filer_public/3f/ef/3fef5837-3b41-4bce-b215-de46217f8c31/pearc25-15_final.pdf" target="_blank" rel="noopener">Chameleon site (PDF)</a> or via its DOI, <a href="https://doi.org/10.1145/3708035.3736014" target="_blank" rel="noopener">10.1145/3708035.3736014</a>.</p>
